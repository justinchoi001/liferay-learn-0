...
To enable advanced monitoring with Dynatrace on Liferay DXP in production, set the two `*_DYNATRACE_*` environment variables described in the above table. Here's an example:
